/*
 *		Confirmation Modal Layout Template
 *
 *
 *		This is a React template to design confirmation pop-ups generated by the website. It contains needed buttons like "confirm" and "cancel", and also displays the information that the pop-up
 *		is trying to send. It also bakes in relevant animations for the apperance and disappearnce of the pop-up.
 */
